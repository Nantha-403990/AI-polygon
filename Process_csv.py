...
PARTITION_DIR = "D:/SEM4/EB/My_try/Data/merged"  
...
def graph_to_pyg(graph):
    ...
    # Optional: encode layout_area_type as unsupervised "node label"
...
if __name__ == "__main__":
    ...
    torch.save(data_list, "processed_apartment_graphs.pt")
